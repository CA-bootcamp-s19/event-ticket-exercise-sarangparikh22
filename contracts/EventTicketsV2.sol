...
contract EventTicketsV2 {
    ...
    */
    function buyTickets(uint _eventID, uint _tickets) public payable {
        ...
        require(msg.value >= PRICE_TICKET * _tickets);
        require(events[_eventID].totalTickets >= events[_eventID].sales +_tickets);
        events[_eventID].buyers[msg.sender] += _tickets;
        events[_eventID].sales += _tickets;
        msg.sender.transfer(msg.value - (PRICE_TICKET * _tickets));
    ...
    */
    function getRefund(uint _eventID) public {
        ...
        msg.sender.transfer(PRICE_TICKET * events[_eventID].buyers[msg.sender]);
